...
# IDs anpassen
BEWERBUNGS_KANAL_ID = 1416458225552851066   # Kanal für Bewerbungen
PROTOKOLL_KANAL_ID = 1416458225552851065    # Kanal für Protokoll
MEMBER1_ID = 1416459765130723631            # Rolle 1
MEMBER2_ID = 1416459872278675567            # Rolle 2

# --- Modal für Bewerber ---
class BewerbungModal(discord.ui.Modal):
    def _init_(self):
        super()._init_(title="Bewerbungs Vorlage El Salvador")
...
class BewerbungReviewView(discord.ui.View):
    def _init_(self, bewerber_id: int):
    ...
    @discord.ui.button(label="ℹ Info", style=discord.ButtonStyle.blurple)
